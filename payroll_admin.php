            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="form-row">
                                    ...
                                    <button class="btn btn-primary" type="button" onclick="ListHistoric()">Show result</button>
                    </form>
                        ...
                        <div class="main-card mb-12 card" id="div_result">
                    <div class="card-body"><h5 class="card-title">List historic  payroll </h5>
