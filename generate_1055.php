                ...
                <div class="app-main__inner">
                    ...
                    <div class="form-row">
                                    ...
                                    <div class="col-md-2 mb-2">
                                            ...
                                            <input type="text" class="form-control" maxlength="10"  name="invoice_number" id="invoice_number" placeholder="Invoice number"  required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-2 mb-2">
                                            <label for="validationCustom01">Porcent(*)</label>
                                            <input type="text" class="form-control" maxlength="5"  name="porcent_ganancia" id="porcent_ganancia" placeholder="Porcent"  required>
                                            <div class="invalid-feedback">
                                            Porcent is required
                                            </div>
                                        </div>
...
<script src="js/generate_1055.js"></script>
</html>