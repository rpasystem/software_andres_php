                ...
                <div class="app-main__inner">
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-actions">
                                ...
                                <a href="crear_empleado.php" type="button" class="mb-2 mr-2 btn-transition btn btn-outline-primary">
                    ...
                    <div class="form-row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" maxlength="25"  name="filtro" id="filtro" placeholder="Filter by full name">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select  id="host_company" name="host_company" class="form-control" Onchange="ChangeHostCompany(this)">
                                    ...
                                    <div class="col-md-3 mb-3">
                                            ...
                                            <select  name="staff_company" id="staff_company" class="form-control">
                                    ...
                                    <div class="col-md-3 mb-3" style="float: left;" >
                                        ...
                                        <div class="table-responsive ">
                                            <table class="mb-0 table table-striped" id="employee">
                                                <thead>
                                                <tr>
                                                    <th>Id</th>
                                                    <th>Full Name</th>
