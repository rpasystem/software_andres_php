...
$data = Print_payrollModel::Data_Membrete($_GET['id']);
...
//$pdf->Image('../img/Hoja-membrete.png',-10,0,-370);
    ...
    $pdf->MultiCell(0,5,$data['datos'][0]['fecha_contratacion'].'Please accept this letter as confirmation that '.$data['datos'][0]['name_emp'].' has been employed with '.$data['datos'][0]['staff'].'. since '.$data['datos'][0]['fecha_contratacion'].'.');
