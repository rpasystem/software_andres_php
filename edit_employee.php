        ...
        <div class="app-main">
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="card-body">
                                <h5 class="card-title">Form edit employee</h5>
                                ...
                                <div class="col-md-6 mb-3">
                                            ...
                                            <input type="file" class="form-control" accept="image/*" id="photo"  onchange="UploadFile(this)">
                                ...
                                <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" maxlength="25"  name="id_employee_edit" id="id_employee_edit" placeholder="Id"  required>
                                            <div class="invalid-feedback">
                                            Id is required
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="address_emp" name="address" maxlength="50"  placeholder="Adress" required>
                                            <div class="invalid-feedback">
                                            Address is required
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="phone" id="phone_edit" maxlength="50" placeholder="Phone number" required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="password" class="form-control" name="password" id="password" maxlength="15" pattern="^(?=.*\d)(?=.*[a-zA-Z])[a-zA-Z\d]{7,15}$" placeholder="Reset Password" >
                                            <div class="invalid-feedback">
      ...
      <div class="input-group-addon">
        <a href=""><i class="fa fa-eye-slash" aria-hidden="true"></i></a>
                                    ...
                                    <div class="col-md-12 mb-3">
                                            ...
                                            <textarea type="text" class="form-control" name="observation" id="observation" maxlength="250" ></textarea>
                                            <div class="invalid-feedback">
